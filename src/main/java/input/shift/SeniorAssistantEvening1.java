...
public class SeniorAssistantEvening1 extends Shift {
    ...
    public SeniorAssistantEvening1(double dailyWorkload) {
        super(dailyWorkload);
    }

    @Override
    public ShiftPeriod getPeriod() {
        return ShiftPeriod.WEEK_WITHOUT_FRIDAY;
    }
